...
class Paciente:
    ...
    contador_pacientes = 0 # Atributo de CLASE (compartido por todos los objetos)
    
    def __init__(self, nombre, edad, telefono, email):
        Paciente.contador_pacientes += 1 # Se accede con NombreClase.atributo
    ...
    def agregar_cita(self, cita):
        #self.historial_citas += [cita]
        self.historial_citas.append(cita) #Equivalente a lo de arriba pero usando POO
    ...
    def mostrar_info(self):
     ...
     # Define cómo se muestra el objeto con print() o str()
    def __str__(self):
...
class Doctor:
    ...
    contador_doctores = 0 # Atributo de CLASE (compartido por todos los objetos)
    ...
    def agregar_cita(self, cita):
        self.citas_programadas.append(cita) # append() agrega un elemento al final de la lista
    ...
    def mostrar_info(self):
        citas_activas = len([c for c in self.citas_programadas if c.estado == "Programada"]) #comprenhension list
...
class Cardiologo(Doctor):
    def __init__(self, nombre, telefono):
        super().__init__(nombre, "Cardiología", telefono)
        self.costo_consulta = 800 #Dólares

class Pediatra(Doctor):
    def __init__(self, nombre, telefono):
        super().__init__(nombre, "Pediatría", telefono)
        self.costo_consulta = 600

class Dermatologo(Doctor):
    def __init__(self, nombre, telefono):
        super().__init__(nombre, "Dermatología", telefono)
...
class Cita:
    ...
    def mostrar_info(self):
        ...
        #Si existe diagnostico entonces lo muestra
        if self.diagnostico:
...
class Consultorio:
    ...
    def agendar_cita(self, id_paciente, id_doctor, fecha, hora, motivo):
        paciente = self.buscar_paciente(id_paciente) #Comprobar que existe el paciente
        doctor = self.buscar_doctor(id_doctor) #Comprobar que exista el doc
